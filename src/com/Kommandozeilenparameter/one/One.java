...
//Verbesserungen:
//Exception statt error
//Diviosion durch 0 abgefangen
public class One {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            switch (args[1]) {
                ...
                case "/" -> System.out.println(Double.parseDouble(args[2]) == 0 ? "Fehler: Division durch 0" : String.format("%5.2f / %5.2f = %5.2f", Double.parseDouble(args[0]), Double.parseDouble(args[2]), Double.parseDouble(args[0]) / Double.parseDouble(args[2])));
            }
        } catch (Exception e) {
